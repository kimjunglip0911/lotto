      ...
      <div className="flex flex-col gap-2 w-full sm:w-2/5 md:w-1/3">
        ...
        <select
          ...
          onChange={(event) => {
            ...
            onDrawSelect(value === 'new' ? 'new' : Number(value));
          }}
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-end w-full sm:w-auto gap-3">
        {!isMaxReached ? (
          ...
          >
            ...
            {isGenerating ? '최적 20세트 분석 및 생성 중...' : '통합 20세트 추출하기'}
          </button>
        ) : null}
        ...
        {onGenerateWheel ? (
          ...
          >
            {isGeneratingWheel ? (
              ...
              <span className="material-symbols-outlined text-[22px] text-amber-200">casino</span>
            )}
