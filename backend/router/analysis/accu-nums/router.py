...
@router.get("/api/analysis/accu-nums/draw-numbers", response_model=List[int])
def get_draw_numbers():
    return fetch_draw_numbers(queries.GET_AVAILABLE_DRAW_NOS)


@router.get("/api/analysis/accu-nums/winning-numbers-range", response_model=List[dict])
...
@router.get("/api/analysis/accu-nums/winning-number", response_model=dict)
...
@router.get("/api/analysis/accu-nums/winning-numbers-window", response_model=List[dict])
...
@router.post("/api/analysis/accu-nums/snapshot", response_model=MessageResponse)
...
@router.get("/api/analysis/accu-nums/snapshot", response_model=AccumulatedNumberSnapshotGetResponse)
