export const GET_AVAILABLE_DRAW_NOS = `
SELECT draw_no
FROM lotto_winners
...
export const GET_WINNING_NUMBERS_BY_DRAW = `
SELECT draw_no, num1, num2, num3, num4, num5, num6, bonus_num
FROM lotto_winners
WHERE draw_no = ?
LIMIT 1
...
export const UPSERT_ACCUMULATED_SNAPSHOT = `
...
export const GET_ACCUMULATED_SNAPSHOT_BY_DRAW = `
