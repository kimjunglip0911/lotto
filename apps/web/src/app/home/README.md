...
| `logic/` | 등수 판정·시뮬레이션 통계·당첨번호 정규화(`normalize`: `toNumOrNull`, `toWinNums`, `canCalcWins`)·10세트 묶음(`chunkSets`)·입력 파싱·회차 목록/세트 변환(`parseDrawArr`, `buildDrawList`, `toLotterySets`, `toSetVm`) |
