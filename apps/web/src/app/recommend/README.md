...
- 적용 규칙 ID: `full-pool-45`, `exclude-prev-draw-7`, `combination-rank-30sets`, `stats-window-three-year`, `gap-set-ranks-1-10`, `pos-band-ranks-11-17`, `equal-zero-ranks-18-20`, `pos-band-ladder-fallback`, `unused-pool-tail-fill`.
