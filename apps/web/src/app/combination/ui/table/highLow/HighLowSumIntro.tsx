import { STATS_WINDOW_DRAWS, STATS_WINDOW_LABEL } from '@/lib/statsWindow';
    ...
    <>
      <div>
        ...
        <p className="text-xs text-slate-400 mt-1">
          표본: DB에 저장된 최근 {STATS_WINDOW_DRAWS}회({STATS_WINDOW_LABEL}) 당첨 주번호 6개(num1~num6)만 합산합니다. 보너스 번호는 제외합니다. 합산이
        ...
        <p className="text-xs text-slate-400 mt-1">
          ...
          남은 쪽 최소가 위로 올라가므로(예: 98→113) 숫자가 커지는 것이 맞습니다. 최근 회차(최대 {STATS_WINDOW_DRAWS}회)는{' '}
