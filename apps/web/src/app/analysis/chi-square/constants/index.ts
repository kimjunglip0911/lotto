 ...
 * 부동소수 비교 대신 정수식으로 경계(예: 10.01%급)를 맞춘다.
 */
export const CHI_SQUARE_WALK_FORWARD_EXCLUSION_MAX_PCT_NUMERATOR = 10;
/** 겹침 회차(`roundsMatched`)가 이 값 이하면 제외(초과만 잔여). */
export const CHI_SQUARE_WALK_FORWARD_EXCLUSION_MAX_OVERLAP_ROUNDS = 5;
